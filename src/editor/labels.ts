...
export const FIELD_LABELS: Record<string, string> = {
  ...
  'auto_discover_timers': 'Timer Helpers',
  ...
  'timer_entities': 'Helpers To Discover',
  'show_days': 'Days',
  'show_hours': 'Hours',
...
export const FIELD_HELPERS: Record<string, string> = {
  ...
  'section_timer_rows': 'Leave a field empty to keep the theme default. These rows carry no brand colour of their own.',
  ...
  'timer_entities': 'Leave empty to discover every timer helper on the system',
