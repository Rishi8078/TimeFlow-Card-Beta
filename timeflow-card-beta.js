    ...
    `}_renderCard(){var e;const{title:t,subtitle:i,text_color:s,background_color:r,progress_color:o,stroke_width:a,icon_size:n,expired_animation:l=!0,expired_text:c="",invert_progress:d=!1,mode:u="count_down",width:h,height:m,aspect_ratio:p,show_months:g,show_days:_,show_hours:f,show_minutes:v,show_seconds:y,compact_format:b}=this._resolvedConfig,w=[this._resolvedConfig.show_years,g,this._resolvedConfig.show_weeks,_,f,v,y].filter(e=>!0===e).length,x=!0===b||!1!==b&&w>=3,{cardBackground:$,textColor:S}=this._getCardColors(),T=o||s||"var(--progress-color, #4caf50)",C=this.styleManager.calculateDynamicIconSize(h,m,p,n),k=this.styleManager.calculateDynamicStrokeWidth(C,a),A=this.styleManager.calculateProportionalSizes(h,m,p),M=this.styleManager.generateCardDimensionStyles(h,m,p),D=[...$?[`background: ${$}`,`--timeflow-card-background-color: ${$}`]:[],...S?[`color: ${S}`,`--timeflow-card-text-color: ${S}`,`--progress-text-color: ${S}`]:[],`--timeflow-card-progress-color: ${T}`,`--timeflow-card-icon-size: ${C}px`,`--timeflow-card-stroke-width: ${k}`,`--timeflow-title-size: ${A.titleSize}rem`,`--timeflow-subtitle-size: ${A.subtitleSize}rem`,...M].join("; "),E=this._resolvedConfig.timer_entity||this._resolvedConfig.auto_discover_alexa||this._resolvedConfig.auto_discover_google?!1!==b:x;let I;if(this._resolvedConfig.timer_entity&&this.hass){const e=ke.getTimerData(this._resolvedConfig.timer_entity,this.hass);I=e?this._expired&&(e.isAlexaTimer||e.isGoogleTimer)?ke.getTimerSubtitle(e,!1!==this._resolvedConfig.show_seconds,this._localize||void 0,E):this._expired?c||this.countdownService.getSubtitle(this._resolvedConfig,this.hass,this._localize||void 0,E):i||ke.getTimerSubtitle(e,!1!==this._resolvedConfig.show_seconds,this._localize||void 0,E):this._expired?c||this.countdownService.getSubtitle(this._resolvedConfig,this.hass,this._localize||void 0,E):i||this.countdownService.getSubtitle(this._resolvedConfig,this.hass,this._localize||void 0,E)}else I=this._resolvedConfig.auto_discover_alexa?i||this.countdownService.getSubtitle(this._resolvedConfig,this.hass,this._localize||void 0,E):this._expired?c||this.countdownService.getSubtitle(this._resolvedConfig,this.hass,this._localize||void 0,E):i||this.countdownService.getSubtitle(this._resolvedConfig,this.hass,this._localize||void 0,E);const N=this._getTitleText(),R=this._getCardClasses(l),{configWithDefaults:z,shouldEnableActions:P}=this._getActionConfig(),O=this._hasHeaderIcon(),H=d?100-this._progress:this._progress,F=`${"count_up"===u?"Elapsed":"Countdown"} progress: ${Math.round(H)}%`;return G`
      ...
      >
        <div class="card-content">
          <header class="header" style="${O?`--header-icon-container-size: calc(${A.titleSize}rem * 1.3 + ${A.subtitleSize}rem * 1.2 + 2px); --header-icon-size: calc(${A.titleSize}rem * 0.9 + ${A.subtitleSize}rem * 0.7);`:""}">
            ${O?G`
