...
>${e}</code>`,Lt={section_appearance:()=>G`
    ...
    `},Ut={date:"Count to a date or entity you choose",timer:"Follow one timer, sensor or input_datetime entity",auto:"Follows any running Alexa or Google Home timer"};class Gt extends ne{constructor(){super(...arguments),this.hass=null,this._config={type:"custom:timeflow-card-beta"},this._pendingSource=null,this._templateMode={},this._codeEditorReady=!!customElements.get("ha-code-editor"),this._menuReady=!!customElements.get("ha-control-select-menu"),this._tooltipReady=!!customElements.get("ha-tooltip"),this._templateModeTouched=new Set,this._computeHelper=e=>{const t=Lt[null==e?void 0:e.name];return t?t():function(e){return Pt[null==e?void 0:e.name]||""}(e)}}static get styles(){return a`
        ...
        `}_sourceChanged(e){var t;e.stopPropagation();const i=null===(t=e.detail)||void 0===t?void 0:t.value;if(!i||i===bt(this._config,this._pendingSource))return;const s=function(e,t){const i={...e};for(const s of Object.keys(yt))if(s!==t)for(const e of yt[s])delete i[e];return"auto"!==t||i.auto_discover_alexa||i.auto_discover_google||(i.auto_discover_alexa=!0,i.auto_discover_google=!0),i}(this._config,i);this._config=s,this._pendingSource=ft(s)===i?null:i,this._fireConfigChanged(s)}_renderDateField(e,t,i){var s;return this._renderTemplatableField(e,t,i,G`
