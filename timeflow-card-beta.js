        ...
        `:W;return G`
            ...
            <div class="editor-block">
                ...
                <ha-form
                    .hass=${this.hass}
                    .data=${i}
                    .schema=${[{name:"style",selector:{select:{options:xt,mode:"box",box_max_columns:2}}}]}
                    @value-changed=${e=>this._formChanged(e)}
                    .computeLabel=${Rt}
                    .computeHelper=${this._computeHelper}
                ></ha-form>
            ...
            `:W}
            ${u?this._renderTitleField():W}
            ${h?this._renderSubtitleField():W}
            ${o.length>0?G`
                <div class="date-field-container">
                    <ha-form
                        .hass=${this.hass}
            ...
            `:W}
            ${m?this._renderExpiredTextField():W}
            <ha-form
                .hass=${this.hass}
                .data=${i}
                .schema=${n}
