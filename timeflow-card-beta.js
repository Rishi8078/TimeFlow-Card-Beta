...
>${e}</code>`,jt={section_appearance:()=>G`
    ...
    `},Wt={date:"Count to a date or entity you choose",timer:"Follow one timer, sensor or input_datetime entity",auto:"Follows any running Alexa or Google Home timer"};class qt extends ne{constructor(){super(...arguments),this.hass=null,this._config={type:"custom:timeflow-card-beta"},this._pendingSource=null,this._templateMode={},this._codeEditorReady=!!customElements.get("ha-code-editor"),this._menuReady=!!customElements.get("ha-control-select-menu"),this._tooltipReady=!!customElements.get("ha-tooltip"),this._templateModeTouched=new Set,this._computeHelper=e=>{const t=jt[null==e?void 0:e.name];return t?t():function(e){return Ft[null==e?void 0:e.name]||""}(e)}}static get styles(){return a`
            .section-header {
                font-weight: 500;
                font-size: 14px;
                color: var(--primary-text-color);
        ...
        `}}e([ue({type:Object})],qt.prototype,"hass",void 0),e([he()],qt.prototype,"_config",void 0),e([he()],qt.prototype,"_pendingSource",void 0),e([he()],qt.prototype,"_templateMode",void 0),e([he()],qt.prototype,"_codeEditorReady",void 0),e([he()],qt.prototype,"_menuReady",void 0),e([he()],qt.prototype,"_tooltipReady",void 0),customElements.get("error-display-beta")||customElements.define("error-display-beta",st),customElements.get("progress-circle-beta")||customElements.define("progress-circle-beta",ut),customElements.get("progress-grid-beta")||customElements.define("progress-grid-beta",ht),customElements.get("timeflow-card-beta")||customElements.define("timeflow-card-beta",dt),customElements.get("timeflow-card-beta-editor")||customElements.define("timeflow-card-beta-editor",qt),window.customCards=window.customCards||[],window.customCards.some(e=>"timeflow-card-beta"===e.type)||window.customCards.push({type:"timeflow-card-beta",name:"TimeFlow Card beta",description:"A beautiful countdown timer card with progress circle for Home Assistant, using Lit",preview:!0,documentationURL:"https://github.com/Rishi8078/TimeFlow-Card"});export{st as ErrorDisplayBeta,ut as ProgressCircleBeta,ht as ProgressGridBeta,dt as TimeFlowCardBeta,qt as TimeFlowCardEditorBeta};
