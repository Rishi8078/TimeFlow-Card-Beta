...
>${e}</code>`,Ft={section_appearance:()=>G`
    ...
    `},Ht={date:"Count to a date or entity you choose",timer:"Follow one timer, sensor or input_datetime entity",auto:"Follows any running Alexa or Google Home timer"};class Ut extends ne{constructor(){super(...arguments),this.hass=null,this._config={type:"custom:timeflow-card-beta"},this._pendingSource=null,this._templateMode={},this._codeEditorReady=!!customElements.get("ha-code-editor"),this._menuReady=!!customElements.get("ha-control-select-menu"),this._templateModeTouched=new Set,this._computeHelper=e=>{const t=Ft[null==e?void 0:e.name];return t?t():function(e){return Rt[null==e?void 0:e.name]||""}(e)}}static get styles(){return a`
        ...
        `:W;return G`
            ...
            ${p?W:this._renderSourcePicker(i,s)}
            ${g}
            ${p?W:this._renderSourceFields(i,r,s)}
            ${p&&u?this._renderTitleField():W}
            ${a.length>0?G`
                <div class="editor-section">
