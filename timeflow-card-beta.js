      ...
      >
        <div class="card-content-minimal-square">
          ...
          <div class="minimal-square-progress">
            <div class="minimal-square-shell" role="group" aria-label="${F}">
              <progress-circle-beta
