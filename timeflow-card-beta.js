...
>${e}</code>`,Ft={section_appearance:()=>G`
        Colours accept ${Ht("#4caf50")}, ${Ht("rgb()")}, a CSS name,
        ${Ht("var(--…)")}, or an entity id.
    `},Lt={date:"Count to a date or entity you choose",timer:"Follow one timer, sensor or input_datetime entity",auto:"Follows any running Alexa or Google Home timer"};class Ut extends ne{constructor(){super(...arguments),this.hass=null,this._config={type:"custom:timeflow-card-beta"},this._pendingSource=null,this._templateMode={},this._codeEditorReady=!!customElements.get("ha-code-editor"),this._menuReady=!!customElements.get("ha-control-select-menu"),this._tooltipReady=!!customElements.get("ha-tooltip"),this._templateModeTouched=new Set,this._computeHelper=e=>{const t=Ft[null==e?void 0:e.name];return t?t():function(e){return zt[null==e?void 0:e.name]||""}(e)}}static get styles(){return a`
            .section-header {
                font-weight: 500;
                font-size: 14px;
                color: var(--primary-text-color);
        ...
        `}_updateDateField(e,t){const i={...this._config,[e]:t};this._config=i,this._fireConfigChanged(i)}_toggleTemplateMode(e){this._templateModeTouched.add(e),this._templateMode={...this._templateMode,[e]:!this._templateMode[e]}}_getEffectiveCompactFormat(){const{show_years:e,show_months:t,show_weeks:i,show_days:s,show_hours:r,show_minutes:o,show_seconds:a,compact_format:n}=this._config;if(void 0!==n)return n;const l=[e,t,i,s,r,o,a].filter(e=>!0===e).length;return l>=3}render(){const e=this._config||{},t="count_up"===e.mode?"count_up":"count_down",i={...e,mode:t,compact_format:this._getEffectiveCompactFormat()},s=bt(i,this._pendingSource),r=function(e,t){const i=null!=t?t:ft(e);return[...Ct(i,_t(e)),...Mt(e,i)]}(i,s),o=Nt(i,s),a=gt(i).timerList?[{type:"grid",schema:[{name:"auto_discover_alexa",selector:{boolean:{}}},{name:"auto_discover_google",selector:{boolean:{}}}]},{name:"max_timers",selector:{number:{min:1,max:20,step:1,mode:"box"}}},{type:"grid",schema:[{name:"alexa_icon",selector:{icon:{}}},{name:"google_icon",selector:{icon:{}}}]},{type:"grid",schema:[{name:"show_seconds",selector:{boolean:{}}},{name:"compact_format",selector:{boolean:{}}}]}]:[];const n=function(e){return gt(e).timerList?[{type:"tf_countdowns",name:"countdowns"}]:[]}(i),l=function(e){return gt(e).expiredAnimation?[{name:"expired_animation",selector:{boolean:{}}}]:[]}(i),c=function(e){return"listy"===_t(e)?[]:function(e){const t=[];e.timeUnits&&t.push({name:"show_years",selector:{boolean:{}}},{name:"show_months",selector:{boolean:{}}},{name:"show_weeks",selector:{boolean:{}}},{name:"show_days",selector:{boolean:{}}},{name:"show_hours",selector:{boolean:{}}},{name:"show_minutes",selector:{boolean:{}}}),e.showSeconds&&t.push({name:"show_seconds",selector:{boolean:{}}});const i=[];return t.length>0&&i.push({type:"grid",schema:t}),e.compactFormat&&i.push({name:"compact_format",selector:{boolean:{}}}),i}(gt(e))}(i),d=function(e){const t=gt(e);return[...kt(t),...At(t),...Et(t),...Dt(t),...It(t),{type:"expandable",name:"section_actions",flatten:!0,title:"Tap Actions",icon:"mdi:gesture-tap",schema:[{name:"tap_action",selector:{ui_action:{}}},{name:"hold_action",selector:{ui_action:{}}},{name:"double_tap_action",selector:{ui_action:{}}}]}]}(i),u=gt(i),h=u.title,m=u.subtitle,p=u.expiredText,_="listy"===_t(i),g=yt(s)?G`
        ...
        `:W;return G`
            ...
            ${_?W:this._renderSourcePicker(i,s)}
            ${g}
